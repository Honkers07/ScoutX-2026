...
export default function VideoScout() {
  ...
  const [redOfficialScore, setRedOfficialScore] = useState(null);
  ...
  const [blueOfficialScore, setBlueOfficialScore] = useState(null);
  ...
  const handleSubmit = async () => {
    if (!canSubmit) {
      setAlert({
        open: true,
        message:
          "Please process both Red and Blue alliance videos before submitting",
        severity: "error",
      });
      return;
    }
    ...
    dataRef.current.set("redOfficialScore", redOfficialScore);
    dataRef.current.set("blueOfficialScore", blueOfficialScore);
      ...
      <Stack direction="column" spacing={2} mt={2} pb={6} align="center">
        ...
        {stage === VideoStage.VIDEO_PROCESSING && (
          <>
            ...
            <Box sx={{ width: "100%" }}>
              {currentTab === 0 && (
                <VSAllianceTab
                  ...
                  officialScore={redOfficialScore}
                  setOfficialScore={setRedOfficialScore}
              ...
              {currentTab === 1 && (
                <VSAllianceTab
                  ...
                  officialScore={blueOfficialScore}
                  setOfficialScore={setBlueOfficialScore}
            ...
            {/* Status Summary */}
            <Paper
              sx={{ p: 2, mt: 2, backgroundColor: "rgba(255,255,255,0.05)" }}
            >
              ...
              <Stack direction="row" spacing={3}>
                <Stack direction="row" alignItems="center">
                  ...
                  <Typography variant="body2" color="white">
                    Red:{" "}
                    {isRedComplete ? `${redTotalScore} points` : "Not complete"}
                  </Typography>
                </Stack>
                <Stack direction="row" alignItems="center">
